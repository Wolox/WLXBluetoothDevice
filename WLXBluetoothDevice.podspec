...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of WLXBluetoothDevice in Markdown format.
  ...
  # Or just: s.author    = "Wolox"
  # s.authors            = { "Wolox" => "contact@wolox.com.ar" }
  # s.social_media_url   = "http://twitter.com/Wolox"
